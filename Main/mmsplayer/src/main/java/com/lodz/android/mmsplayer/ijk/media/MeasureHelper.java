...
public final class MeasureHelper {
	...
	public static String getAspectRatioText(Context context, int aspectRatio) {
		...
		switch (aspectRatio) {
			case IRenderView.AR_ASPECT_FIT_PARENT:
				text = context.getString(R.string.mmsplayer_videoview_ar_aspect_fit_parent);
				break;
			case IRenderView.AR_ASPECT_FILL_PARENT:
				text = context.getString(R.string.mmsplayer_videoview_ar_aspect_fill_parent);
				break;
			case IRenderView.AR_ASPECT_WRAP_CONTENT:
				text = context.getString(R.string.mmsplayer_videoview_ar_aspect_wrap_content);
				break;
			case IRenderView.AR_MATCH_PARENT:
				text = context.getString(R.string.mmsplayer_videoview_ar_match_parent);
				break;
			case IRenderView.AR_16_9_FIT_PARENT:
				text = context.getString(R.string.mmsplayer_videoview_ar_16_9_fit_parent);
				break;
			case IRenderView.AR_4_3_FIT_PARENT:
				text = context.getString(R.string.mmsplayer_videoview_ar_4_3_fit_parent);
				break;
			default:
