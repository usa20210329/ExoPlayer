...
public class IjkPlayerSetting {
	 ...
	 * 是否使用OpenGLES
	 */
	public boolean isUsingOpenSLES = false;

	//--------------------------- 设置像素格式 -----------------------------------
	@Retention(RetentionPolicy.SOURCE)
	@IntDef({PixelFormatType.PIXEL_AUTO, PixelFormatType.PIXEL_RGB_565, PixelFormatType.PIXEL_RGB_888, PixelFormatType.PIXEL_RGBX_8888, PixelFormatType.PIXEL_YV12, PixelFormatType.PIXEL_OPENGL_ES2})
	...
	//--------------------------- 播放器长宽比类型 -----------------------------------
	@Retention(RetentionPolicy.SOURCE)
	@IntDef({IRenderView.AR_ASPECT_FIT_PARENT, IRenderView.AR_ASPECT_FILL_PARENT, IRenderView.AR_ASPECT_WRAP_CONTENT, IRenderView.AR_MATCH_PARENT, IRenderView.AR_16_9_FIT_PARENT, IRenderView.AR_4_3_FIT_PARENT})
